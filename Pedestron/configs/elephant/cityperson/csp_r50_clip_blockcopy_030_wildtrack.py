...
data = dict(
    ...
    test=dict(
        ...
        clip_length=CLIP_LENGTH),
    wildtrack=dict(
        train='/home/wiser-renjie/projects/blockcopy/Pedestron/datasets/Wildtrack/cam1',
        test='/home/wiser-renjie/projects/blockcopy/Pedestron/datasets/Wildtrack/cam7'))
# optimizer
# optimizer = dict(
#     type='SGD',
#     lr=0.01/10,
